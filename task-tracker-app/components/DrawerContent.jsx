...
const DrawerList = [
    { icon: 'house', label: 'Home', navigateTo: 'Home' },
    { icon: 'person', label: 'Profile', navigateTo: 'Profile' },
    { icon: 'gear', label: 'Settings', navigateTo: 'User' },
]
